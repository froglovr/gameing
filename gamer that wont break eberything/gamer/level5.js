class level5 {
    constructor() {
        ...
        for (let i = 0; i < 2; i++) {
            for (let j = 0; j < 4; j++) {
                this.children.push(new spookMoment(580 + 50 * i, 340 + 50 * j));
            }
        }
        for (let i = 0; i < 3; i++) {
            for (let j = 0; j < 17; j++) {
        ...
        for (let i = 0; i < 3; i++) {
            for (let j = 0; j < 15; j++) {
                this.children.push(new spookMoment(50 * i - 18, 300 + 50 * j));
            }
        }
        for (let i = 0; i < 14; i++) {
            for (let j = 0; j < 3; j++) {
                this.children.push(new spookMoment(130 + 50 * i, 850 + 50 * j));
            }
        }
    }
    Draw() {
